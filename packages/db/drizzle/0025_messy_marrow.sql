...
ALTER TABLE "subscriptions" ALTER COLUMN "interval" SET DATA TYPE text;--> statement-breakpoint
...
ALTER TABLE "subscriptions" ALTER COLUMN "interval" SET DATA TYPE "public"."subscription_interval" USING "interval"::"public"."subscription_interval";--> statement-breakpoint
